...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Adamantlegioncoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"adamantlegioncointools.com", "74.99.88.40"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"adamantlegioncointools.com", "testnet-seed.adamantlegioncointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Adamantlegioncoin is probably already running."), addrBind.ToString().c_str());
        else
